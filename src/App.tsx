  ...
  return (
    <>
      ...
      <div className="relative z-10 h-[100dvh] w-full flex flex-col px-5 py-3 sm:py-6 overflow-hidden">
        <div className="w-full max-w-lg mx-auto flex flex-col items-center flex-1">
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center gap-1.5 mt-3 mb-3 max-w-sm shrink-0"
          >
            ...
            <AnimatePresence mode="wait">
              {lastAffirmation && (
                ...
                >
                  ...
                  {/* The affirmation */}
                  <p className="text-xl sm:text-2xl md:text-3xl font-light leading-snug text-white/85 italic mb-4 px-1"
          ...
          <div className="shrink-0 w-full flex flex-col items-center gap-3 pb-2">
            {/* Action buttons */}
            <motion.div
            ...
            >
              <button
                ...
                className="flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-teal-500/30 text-white/60 hover:text-teal-300 transition-all duration-300 text-[10px] uppercase tracking-[0.15em] font-semibold backdrop-blur-sm"
              >
                <RefreshCw size={12} />
                Nueva
              </button>
              <button
                onClick={handleShare}
                disabled={isSharing}
                className="flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-teal-500/10 hover:bg-teal-500/20 border border-teal-500/20 hover:border-teal-500/40 text-teal-300/70 hover:text-teal-300 transition-all duration-300 text-[10px] uppercase tracking-[0.15em] font-semibold backdrop-blur-sm disabled:opacity-50"
              >
                <Share2 size={12} />
            ...
            >
              ...
              <p className="text-[8px] text-white/15 uppercase tracking-[0.2em] font-medium">
